...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (type === 'acceptance') {
      subject = 'Ujjwalit Technologies — Internship Offer';
      html = getAcceptanceEmailHtml(app.full_name, trackName);
    } else if (type === 'onboarding') {
      subject = 'Ujjwalit Technologies — Onboarding Credentials & Setup';
      html = getOnboardingEmailHtml(app.full_name, trackName, student.student_code);
      ...
      subject = 'Ujjwalit Technologies — Internship Completion Certificate';
      html = getCompletionEmailHtml(app.full_name, trackName, cert.certificate_id);
    } else {
